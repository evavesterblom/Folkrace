...
#define MOTOR_DIR_1_Pin GPIO_PIN_0
...
#define MOTOR_PWM_2_Pin GPIO_PIN_7
#define MOTOR_PWM_2_GPIO_Port GPIOA
#define TOF_1_Pin GPIO_PIN_13
#define TOF_1_GPIO_Port GPIOB
#define TOF_2_Pin GPIO_PIN_14
#define TOF_2_GPIO_Port GPIOB
#define TOF_3_Pin GPIO_PIN_15
#define TOF_3_GPIO_Port GPIOB
#define TMS_Pin GPIO_PIN_13
#define TMS_GPIO_Port GPIOA
#define TCK_Pin GPIO_PIN_14
#define TCK_GPIO_Port GPIOA
#define TOF_CLOCK_Pin GPIO_PIN_8
#define TOF_CLOCK_GPIO_Port GPIOB
#define TOF_DATA_Pin GPIO_PIN_9
#define TOF_DATA_GPIO_Port GPIOB
